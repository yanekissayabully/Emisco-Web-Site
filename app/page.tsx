...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-card to-background">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent"></div>
        
        <div className="relative z-10 text-center text-foreground max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif font-black mb-6 sm:mb-8 leading-tight animate-in slide-in-from-bottom-4 duration-1000">
            {t('heroTitle')}
          </h1>

          <p className="text-lg sm:text-xl lg:text-2xl mb-8 sm:mb-10 text-muted-foreground max-w-4xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom-4 duration-1000 delay-500">
            {t('heroSubtitle')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center animate-in slide-in-from-bottom-4 duration-1000 delay-700">
            <Button
              asChild
              size="lg"
              className="text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-4 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-4 border-border/40 bg-background/50 text-foreground hover:bg-accent hover:text-accent-foreground backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
            >
              <Link href="/product">{t('readMore')}</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 sm:bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-foreground/30 rounded-full flex justify-center">
            <div className="w-1 h-2 sm:h-3 bg-foreground/50 rounded-full mt-1 sm:mt-2 animate-pulse"></div>
          </div>
        </div>
      </section>

      {/* Features Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-background via-card to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-black text-primary mb-4 sm:mb-6 animate-in slide-in-from-bottom-4 duration-1000">
              {t('featuresTitle')}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <Card className="text-center border border-border/50 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-card/50 group animate-in slide-in-from-bottom-4 duration-1000 delay-300">
              <CardContent className="p-6 sm:p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Leaf className="h-8 w-8 sm:h-10 sm:w-10 text-primary" />
                </div>
                <h3 className="text-lg sm:text-xl font-serif font-bold mb-3 sm:mb-4 text-card-foreground">{t('ecoFriendly')}</h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  {t('ecoDescription')}
                </p>
              </CardContent>
            ...
            <Card className="text-center border border-border/50 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-card/50 group animate-in slide-in-from-bottom-4 duration-1000 delay-400">
              <CardContent className="p-6 sm:p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-secondary/10 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Shield className="h-8 w-8 sm:h-10 sm:w-10 text-secondary" />
                </div>
                <h3 className="text-lg sm:text-xl font-serif font-bold mb-3 sm:mb-4 text-card-foreground">
                  {t('reliable')}
                </h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  {t('reliableDescription')}
            ...
            <Card className="text-center border border-border/50 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-card/50 group animate-in slide-in-from-bottom-4 duration-1000 delay-500">
              <CardContent className="p-6 sm:p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Recycle className="h-8 w-8 sm:h-10 sm:w-10 text-primary" />
                </div>
                <h3 className="text-lg sm:text-xl font-serif font-bold mb-3 sm:mb-4 text-card-foreground">{t('innovative')}</h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  {t('innovativeDescription')}
                </p>
              </CardContent>
            ...
            <Card className="text-center border border-border/50 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-card/50 group animate-in slide-in-from-bottom-4 duration-1000 delay-600">
              <CardContent className="p-6 sm:p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-secondary/10 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Zap className="h-8 w-8 sm:h-10 sm:w-10 text-secondary" />
                </div>
                <h3 className="text-lg sm:text-xl font-serif font-bold mb-3 sm:mb-4 text-card-foreground">{t('energyEfficient')}</h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  {t('energyDescription')}
                </p>
              </CardContent>
      ...
      {/* About Preview Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-card to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 animate-in slide-in-from-left-4 duration-1000 delay-400">
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-primary/5 border border-primary/10">
                  ...
                  <div>
                    <div className="font-semibold text-card-foreground text-sm sm:text-base">{t('expertTeam')}</div>
                    <div className="text-xs sm:text-sm text-muted-foreground">{t('industrySpecialists')}</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-secondary/5 border border-secondary/10">
                  ...
                  <div>
                    <div className="font-semibold text-card-foreground text-sm sm:text-base">{t('certifiedQuality')}</div>
                    <div className="text-xs sm:text-sm text-muted-foreground">{t('isoStandards')}</div>
                  </div>
                </div>
              </div>
              ...
              <Button
                asChild
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 animate-in slide-in-from-left-4 duration-1000 delay-500"
              >
                <Link href="/about">
                  {t('learnMore')} <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Link>
            ...
            <div className="relative animate-in slide-in-from-right-4 duration-1000 delay-300">
              <div className="relative overflow-hidden rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-500 border border-border/50">
                <img
                  src="/1.webp"
                  alt="Sustainable construction with Emisco blocks"
                  className="w-full h-auto"
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 sm:w-24 sm:h-24 bg-primary/20 rounded-full blur-xl"></div>
              <div className="absolute -bottom-4 -left-4 w-24 h-24 sm:w-32 sm:h-32 bg-secondary/20 rounded-full blur-xl"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
            <div className="order-2 lg:order-1 relative animate-in slide-in-from-left-4 duration-1000 delay-300">
              ...
              <div className="absolute -top-6 -left-6 w-24 h-24 sm:w-32 sm:h-32 bg-secondary/20 rounded-full blur-xl"></div>
            </div>
            <div className="order-1 lg:order-2 space-y-6 sm:space-y-8">
              <div>
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-black text-primary mb-6 sm:mb-8 leading-tight animate-in slide-in-from-right-4 duration-1000">
              ...
              <div className="space-y-4 sm:space-y-6 animate-in slide-in-from-right-4 duration-1000 delay-300">
                <div className="flex items-start space-x-4 p-3 sm:p-4 rounded-xl bg-primary/5 border-l-4 border-primary">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-card-foreground mb-1 text-sm sm:text-base">{t('fireResistance')}</p>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      {t('fireDescription')}
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 p-3 sm:p-4 rounded-xl bg-secondary/5 border-l-4 border-secondary">
                  <div className="w-3 h-3 bg-secondary rounded-full mt-2 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-card-foreground mb-1 text-sm sm:text-base">{t('lightWeight')}</p>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      {t('lightDescription')}
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4 p-3 sm:p-4 rounded-xl bg-primary/5 border-l-4 border-primary">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-card-foreground mb-1 text-sm sm:text-base">{t('breathable')}</p>
                    <p className="text-muted-foreground text-sm sm:text-base">
                      {t('breathableDescription')}
                    </p>
                  </div>
              ...
              <Button
                asChild
                size="lg"
                className="bg-secondary hover:bg-secondary/90 text-secondary-foreground shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 animate-in slide-in-from-right-4 duration-1000 delay-400"
              >
                <Link href="/about">
                  {t('learnMore')} <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Link>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-primary to-primary/90 text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div
            className="absolute inset-0"
            style={{
          ...
          <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center animate-in slide-in-from-bottom-4 duration-1000 delay-300">
              <Button
                size="lg"
                variant="secondary"
                className="text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-4 bg-background text-primary hover:bg-background/90 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
  ...
  size="lg"
  variant="outline"
  className="text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-4 border-background/40 text-background hover:bg-background/10 bg-transparent backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
>
  <a href="tel:+41795760405">{t('writeToUs')}</a>
</Button>
            </div>
          </div>
        </div>
