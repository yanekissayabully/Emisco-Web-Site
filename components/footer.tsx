...
export function Footer() {
  const { t } = useI18n()
  return (
    <footer className="bg-gradient-to-br from-background via-card to-background text-foreground border-t border-border/50">
...
<div className="mb-6">
  <div className="flex items-center gap-3 mb-4">
    ...
    />
    <h2 className="text-2xl font-serif font-black text-primary">Emisco</h2>
  </div>
  ...
  <p className="text-muted-foreground max-w-md leading-relaxed">
    {t('footerSubtitle')}
            ...
            <div className="space-y-3 mt-6">
              <Link 
                href="https://maps.google.com/?q=Britschenmattstrasse 29, 3238 Gals" 
                target="_blank" 
                className="flex items-center space-x-3 text-muted-foreground hover:text-primary transition-colors duration-300 group"
              >
                <MapPin className="h-5 w-5 text-primary flex-shrink-0 group-hover:scale-110 transition-transform" />
                <span>Britschenmattstrasse 29, 3238 Gals</span>
              </Link>
              <Link 
                href="tel:+41795760405" 
                className="flex items-center space-x-3 text-muted-foreground hover:text-primary transition-colors duration-300 group"
              >
              ...
              <Link 
                href="mailto:info@esm-technologie.ch" 
                className="flex items-center space-x-3 text-muted-foreground hover:text-primary transition-colors duration-300 group"
              >
                <Mail className="h-5 w-5 text-primary flex-shrink-0 group-hover:scale-110 transition-transform" />
                <span>info@esm-technologie.ch</span>
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-lg font-serif font-bold mb-6 text-card-foreground">{t('footerNavTitle1')}</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-muted-foreground hover:text-primary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav1')}
                </Link>
              </li>
              <li>
                <Link href="/product" className="text-muted-foreground hover:text-primary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav2')}
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-muted-foreground hover:text-primary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav3')}
                </Link>
              </li>
              <li>
                <Link href="/why-emisco" className="text-muted-foreground hover:text-primary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav4')}
                </Link>
              </li>
            </ul>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-lg font-serif font-bold mb-6 text-card-foreground">{t('footerNavTitle2')}</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/portfolio" className="text-muted-foreground hover:text-secondary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav5')}
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-muted-foreground hover:text-secondary transition-colors duration-300 block py-1 hover:translate-x-1 transform">
                  {t('footerNav6')}
                </Link>
              </li>
            </ul>
